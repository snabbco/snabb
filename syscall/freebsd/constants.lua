...
--c.CAP.MMAP_R              (CAP_MMAP | CAP_SEEK | CAP_READ)
--c.CAP.MMAP_W              (CAP_MMAP | CAP_SEEK | CAP_WRITE)
--c.CAP.MMAP_X              (CAP_MMAP | CAP_SEEK | 0x0000000000000020ULL)
...
--c.CAP.MMAP_RWX            (CAP_MMAP_R | CAP_MMAP_W | CAP_MMAP_X)
