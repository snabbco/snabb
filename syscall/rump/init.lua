...
-- test only
-- this is a simple port of the fstst.c from buildrump.sh just to show it works. As we have only defined C it is pretty gross to use

local ffi = require "ffi"

function octal(s) return tonumber(s, 8) end

local rump = require "syscall.rump.c"
local C = rump.C
