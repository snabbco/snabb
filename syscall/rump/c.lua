...
ssize_t rump___sysimpl_recvfrom(int, void *, size_t, int, struct _netbsd_sockaddr *, _netbsd_socklen_t *);
...
ssize_t rump___sysimpl_readv(int, const struct _netbsd_iovec *, int);
ssize_t rump___sysimpl_writev(int, const struct _netbsd_iovec *, int);
...
ssize_t rump___sysimpl_sendto(int, const void *, size_t, int, const struct _netbsd_sockaddr *, _netbsd_socklen_t);
...
ssize_t rump___sysimpl_preadv(int, const struct _netbsd_iovec *, int, off_t);
ssize_t rump___sysimpl_pwritev(int, const struct _netbsd_iovec *, int, off_t);
