...
local C = {
  ...
  fhopen40 = rump.rump___sysimpl_fhopen40,
  fhstat50 = rump.rump___sysimpl_fhstat50,
  fhstatvfs140 = rump.rump___sysimpl_fhstatvfs140,
  ...
  fstat50 = rump.rump___sysimpl_fstat50,
  ...
  futimes50 = rump.rump___sysimpl_futimes50,
  __getcwd = rump.rump___sysimpl___getcwd,
  getdents30 = rump.rump___sysimpl_getdents30,
  getegid = rump.rump___sysimpl_getegid,
  geteuid = rump.rump___sysimpl_geteuid,
  getfh30 = rump.rump___sysimpl_getfh30,
  ...
  kevent50 = rump.rump___sysimpl_kevent50,
  ...
  lstat50 = rump.rump___sysimpl_lstat50,
  lutimes50 = rump.rump___sysimpl_lutimes50,
  ...
  mknod50 = rump.rump___sysimpl_mknod50,
  mknodat = rump.rump___sysimpl_mknodat,
  modctl = rump.rump___sysimpl_modctl,
  mount50 = rump.rump___sysimpl_mount50,
  ...
  pollts50 = rump.rump___sysimpl_pollts50,
  posix_fadvise50 = rump.rump___sysimpl_posix_fadvise50,
  pread = rump.rump___sysimpl_pread,
  preadv = rump.rump___sysimpl_preadv,
  pselect50 = rump.rump___sysimpl_pselect50,
  ...
  select50 = rump.rump___sysimpl_select50,
  ...
  socket30 = rump.rump___sysimpl_socket30,
  socketpair = rump.rump___sysimpl_socketpair,
  stat50 = rump.rump___sysimpl_stat50,
  ...
  utimes50 = rump.rump___sysimpl_utimes50,
...
C.mknod = C.mknod50
C.mount = C.mount50
C.posix_fadvise = C.posix_fadvise50
C.utimes = C.utimes50
C.futimes = C.futimes50
C.select = C.select50
C.pselect = C.pselect50
C.pollts = C.pollts50
