...
int extattr_delete_link(void);
int extattr_get_fd(void);
int extattr_get_file(void);
int extattr_get_link(void);
int extattr_list_fd(void);
int extattr_list_file(void);
int extattr_list_link(void);
int extattr_set_fd(void);
...
int _ksem_getvalue(void);
int _ksem_init(void);
int _ksem_open(void);
int _ksem_post(void);
int _ksem_trywait(void);
int _ksem_unlink(void);
int _ksem_wait(void);
int lgetxattr(void);
int listxattr(void);
int llistxattr(void);
...
void *dlsym(void *handle, const char *symbol) {
  ...
  if (strcmp(symbol, "luaJIT_BC_include_reflect_reflect") == 0) return luaJIT_BC_include_reflect_reflect; // TODO rename as has -
