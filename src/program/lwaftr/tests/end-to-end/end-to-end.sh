...
snabb_run_and_cmp ${TEST_BASE}/icmp_on_fail.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_ipv6_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp_withoutmac.conf \
   ...
   ${TEST_BASE}/ndp_no_na_next_hop6_mac_not_set.lua
...
snabb_run_and_cmp ${TEST_BASE}/icmp_on_fail.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_ipv6_2.lua
...
snabb_run_and_cmp ${TEST_BASE}/icmp_on_fail.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_icmpv4_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/small_ipv4_mtu_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_ipv4_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/small_ipv4_mtu_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_ipv4_2.lua
...
snabb_run_and_cmp ${TEST_BASE}/small_ipv6_mtu_no_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_ipv6_3.lua
...
snabb_run_and_cmp ${TEST_BASE}/small_ipv6_mtu_no_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_ipv6_4.lua
...
snabb_run_and_cmp ${TEST_BASE}/small_ipv6_mtu_no_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_ipv4_3.lua
...
snabb_run_and_cmp ${TEST_BASE}/small_ipv6_mtu_no_icmp.conf \
   ...
   ${TEST_BASE}/from_inet_ipv4_in_binding_big_packet_df_set.lua
...
snabb_run_and_cmp ${TEST_BASE}/no_icmp.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${TEST_BASE}/in_1p_ipv4_out_none_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/no_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_ipv4_4.lua
...
snabb_run_and_cmp ${TEST_BASE}/no_icmp.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${TEST_BASE}/in_1p_ipv6_out_none_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/icmp_on_fail.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_icmpv6_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/no_icmp.conf \
   ...
   ${TEST_BASE}/from_to_b4_ipv6_hairpin.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${TEST_BASE}/from_to_b4_tunneled_icmpv4_ping_hairpin.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${TEST_BASE}/from_to_b4_tunneled_icmpv4_ping_hairpin_unbound.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_icmpv6_2.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${TEST_BASE}/in_ipv4_ipv6_out_icmpv4_ipv6_hairpin_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/icmp_on_fail.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_ipv6_6.lua
...
snabb_run_and_cmp ${TEST_BASE}/icmp_on_fail.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_ipv4_5.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_ipv6_7.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${TEST_BASE}/in_1p_ipv4_out_none_2.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv4_out_1p_ipv6_8.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${TEST_BASE}/in_1p_ipv6_out_1p_icmpv4_1.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${TEST_BASE}/in_1p_ipv6_out_none_2.lua
...
snabb_run_and_cmp ${TEST_BASE}/tunnel_icmp.conf \
   ...
   ${TEST_BASE}/in_ipv4_ipv6_out_icmpv4_ipv6_hairpin_2.lua
