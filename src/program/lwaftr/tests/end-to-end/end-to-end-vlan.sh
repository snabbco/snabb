...
snabb_run_and_cmp ${TEST_CONF}/icmp_on_fail_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_withoutmac_vlan.conf \
   ...
   ${COUNTERS}/ndp_no_na_next_hop6_mac_not_set.lua
...
snabb_run_and_cmp ${TEST_CONF}/icmp_on_fail_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_2.lua
...
snabb_run_and_cmp ${TEST_CONF}/icmp_on_fail_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_icmpv4_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/small_ipv4_mtu_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv6_out_1p_ipv4_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/small_ipv4_mtu_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv6_out_1p_ipv4_2.lua
...
snabb_run_and_cmp ${TEST_CONF}/small_ipv6_mtu_no_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_3.lua
...
snabb_run_and_cmp ${TEST_CONF}/small_ipv6_mtu_no_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_4.lua
...
snabb_run_and_cmp ${TEST_CONF}/small_ipv6_mtu_no_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv6_out_1p_ipv4_3.lua
...
snabb_run_and_cmp ${TEST_CONF}/small_ipv6_mtu_no_icmp_vlan.conf \
   ...
   ${COUNTERS}/from_inet_ipv4_in_binding_big_packet_df_set.lua
...
snabb_run_and_cmp ${TEST_CONF}/no_icmp_vlan.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${COUNTERS}/in_1p_ipv4_out_none_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/no_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv6_out_1p_ipv4_4.lua
...
snabb_run_and_cmp ${TEST_CONF}/no_icmp_vlan.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${COUNTERS}/in_1p_ipv6_out_none_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/icmp_on_fail_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv6_out_1p_icmpv6_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/no_icmp_vlan.conf \
   ...
   ${COUNTERS}/from_to_b4_ipv6_hairpin.lua
...
# not port-restricted.
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ${EMPTY} ${TEST_DATA}/hairpinned-icmpv4-echo-request.pcap \
   ${EMPTY} ${TEST_DATA}/hairpinned-icmpv4-echo-request-from-aftr.pcap \
   ${COUNTERS}/from_to_b4_tunneled_icmpv4_ping_hairpin.lua

echo "Testing: from-to-b4 tunneled ICMPv4 ping reply, with hairpinning"
# As above, but a reply instead.
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ${EMPTY} ${TEST_DATA}/hairpinned-icmpv4-echo-reply.pcap \
   ${EMPTY} ${TEST_DATA}/hairpinned-icmpv4-echo-reply-from-aftr.pcap \
   ${COUNTERS}/from_to_b4_tunneled_icmpv4_ping_hairpin.lua

echo "Testing: from-to-b4 tunneled ICMPv4 ping, with hairpinning, unbound"
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ${EMPTY} ${TEST_DATA}/hairpinned-icmpv4-echo-request-unbound.pcap \
   ${EMPTY} ${EMPTY} \
   ${COUNTERS}/from_to_b4_tunneled_icmpv4_ping_hairpin_unbound.lua

echo "Testing: from-to-b4 tunneled ICMPv4 ping reply, with hairpinning, port 0 not bound"
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ${EMPTY} ${TEST_DATA}/hairpinned-icmpv4-echo-reply-unbound.pcap \
   ${EMPTY} ${TEST_DATA}/hairpinned-icmpv4-echo-reply-unbound-from-aftr.pcap \
   ${COUNTERS}/in_1p_ipv6_out_1p_icmpv6_2.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_ipv4_ipv6_out_icmpv4_ipv6_hairpin_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/icmp_on_fail_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_6.lua
...
snabb_run_and_cmp ${TEST_CONF}/icmp_on_fail_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv6_out_1p_ipv4_5.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_7.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${COUNTERS}/in_1p_ipv4_out_none_2.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_8.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_1p_ipv6_out_1p_icmpv4_1.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ...
   ${EMPTY} ${EMPTY} \
   ${COUNTERS}/in_1p_ipv6_out_none_2.lua
...
snabb_run_and_cmp ${TEST_CONF}/tunnel_icmp_vlan.conf \
   ...
   ${COUNTERS}/in_ipv4_ipv6_out_icmpv4_ipv6_hairpin_2.lua
...
snabb_run_and_cmp ${TEST_CONF}/no_icmp_with_filters_and_vlan_accept.conf \
   ${TEST_DATA}/ping-v4-and-data.pcap ${EMPTY} ${TEST_DATA}/ping-v4-reply.pcap \
   ${TEST_DATA}/tcp-afteraftr-ipv6.pcap \
   ${COUNTERS}/in_1p_ipv4_out_1p_ipv6_1.lua

echo "Testing: ICMP Echo to AFTR (IPv6)"
snabb_run_and_cmp ${TEST_CONF}/no_icmp_with_filters_and_vlan_accept.conf \
   ${EMPTY} ${TEST_DATA}/ping-v6.pcap \
   ${EMPTY} ${TEST_DATA}/ping-v6-reply.pcap \
   ${COUNTERS}/empty.lua
...
echo "All end-to-end lwAFTR vlan tests passed."
