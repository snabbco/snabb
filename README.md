...
## Release notes
0.7pre bug fixes, filesystem capabilities, xattr bug fixes, general cleanups, signal handler functions, cpu affinity, scheduler functions, POSIX message queues, tun/tap ioctls. Planning to start looking at netfilter, dhcp, selinux.
