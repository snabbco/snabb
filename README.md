...
There is an example epoll script that you can test with Apachebench here https://gist.github.com/1077040 but there are still some not implemented issues, working on them.
